...
// 4TH SECTION
document.addEventListener("DOMContentLoaded", () => {
  const logo = document.getElementById("logo3d-3");
  const shadow = document.querySelector(".logo-shadow-3");
...
// 5TH SECTION
document.addEventListener("DOMContentLoaded", () => {
  const logo = document.getElementById("logo3d-4");
  const shadow = document.querySelector(".logo-shadow-4");
